 ...
 */
definition(
    name: "Garden Humidity Control",
    namespace: "RudeDog69",
    author: "Steven Rudolph",
    description: "Humidity Control for indoor garden.  Controls humidifier and dehumidifier.",
    category: "My Apps",
        ...
        section("Settings") {
       		switch (opt) {
    			case "Smart humidifier" :
        			input "humidiferSwitch", "capability.switch", title: " Turn humidifier switch on or off"
